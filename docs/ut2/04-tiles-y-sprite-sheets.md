...
<figure markdown>
![Tileset y el escenario montado con sus piezas](../assets/ut2/tileset.png)
...
<figure markdown>
![Un tile equivale a un frame de una película](../assets/ut2/tile-frame.png)
<figcaption>Tile = frame. Cada fila de la rejilla puede ser una animación distinta.</figcaption>
</figure>
...
<figure markdown>
![Frames de una animación exportados como sprite sheet](../assets/ut2/spritesheet.png)
...
<figure markdown>
![Todos los frames de una animación comparten tamaño](../assets/ut2/frames-mismo-tamano.png)
...
¿Qué pasa si tu personaje ocupa 21×33 píxeles? En ese caso eliges la potencia de dos inmediatamente superior que lo contenga (aquí, 64×64) y colocas el personaje dentro dejando margen. Ese margen te hará falta cuando el personaje se mueva, extienda los brazos o blanda un arma.

<figure markdown>
![Adaptar un sprite de 21x33 a un frame de 64x64](../assets/ut2/potencia-de-dos.png)
<figcaption>Un sprite de 21×33 se coloca dentro de un frame de 64×64.</figcaption>
</figure>
...
Un tile es una celda de tamaño fijo que sirve para dos cosas: construir escenarios como piezas de puzle y guardar los frames de una animación. Los frames se exportan en un sprite sheet, y para que el motor lo recorte bien todos tienen que medir lo mismo, idealmente una potencia de dos.
