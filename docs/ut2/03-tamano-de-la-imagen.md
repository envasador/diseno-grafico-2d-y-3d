...
<figure markdown>
![El mismo tipo de personaje dibujado con resoluciones crecientes](../assets/ut2/tamano-estilos.png)
<figcaption>Si tu estilo requiere más detalle, necesitas trabajar con resoluciones mayores.</figcaption>
</figure>
...
<figure markdown>
![Una espada a 16x16 y a 32x32 píxeles](../assets/ut2/tamano-16-32.png)
...
<figure markdown>
![Comparación de tamaños de 32x32 a 1024x1024](../assets/ut2/tamano-potencias.png)
...
El tamaño del lienzo es una decisión de diseño que fija el nivel de detalle y la cantidad de trabajo, y en pixel art no se puede cambiar después sin redibujar. Elige entre las potencias de dos pensando en cómo se verá en pantalla, en cuántos frames tendrás que producir y en la rejilla del mundo.
